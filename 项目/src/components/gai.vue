<template>
    <div class="second">
        <div class="form">
            ...
            <el-input prefix-icon="el-icon-lock" v-model="form.password" placeholder="请输入新的密码" clearable
                show-password></el-input>

            <el-button @click="add()" type="primary">修改密码</el-button>

            <el-link type="primary" :underline="false" icon="el-icon-edit"
                @click="Pan(), pushShow('denlu')">快快修改吧，点我返回登录页</el-link>
        </div>
    </div>
            ...
            request({
                ...
                if (value.data.message == '修改成功') {
                    ...
                    this.$message({
                     ...
                     this.$message.error('修改失败，可能是没用英文注册哦');
                }
            }).catch(err => {
                console.log('提交失败')
                console.log(err);
