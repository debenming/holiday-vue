...
export default {
    data() {
        return {
            ...
            message2: {},
            shoppingNum: 1,
            url: [require('../assets/year/1.png'),
            require('../assets/year/2.png'),
            require('../assets/year/3.jpg'),
            require('../assets/year/4.jpg'),]
        }
    },
    methods: {
        open(m) {
    ...
    created() {
        ...
        request({
            ...
            this.message = this.message.filter((p) => { return p.sellname.indexOf('热销') !== -1 })
        }).catch(err => {
            console.log('查询失败')
            console.log(err);
        })
