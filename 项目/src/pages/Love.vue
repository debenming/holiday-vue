...
export default {
    data() {
        return {
            ...
            message2: {},
            shoppingNum: 1,
            url: [require('../assets/mei/1.png'),
            require('../assets/mei/2.png'),
            require('../assets/mei/3.png'),
            require('../assets/mei/4.jpg'),]
        }
    },
    methods: {
        open(m) {
    ...
    created() {
        ...
        request({
            ...
            this.message = this.message.filter((p) => { return p.sellname.indexOf('超爱') !== -1 })
        }).catch(err => {
            console.log('查询失败')
            console.log(err);
        })
